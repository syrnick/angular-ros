...
demoApp.directive('rosBridge', function(){
  return {
    priority: 450,
    compile: function() {
      return {
        pre: function(scope, element, attrs) {
          scope.rosBridge = attrs.rosBridge;
        }
      };
    }
  }
...
demoApp.factory('rosConnection', ['$rootScope', function ($rootScope) {
...
demoApp.controller('ActionCtl', ['$scope','rosConnection', function($scope, rosConnection) {
  $scope.newGoal = {'order': 5};
  $scope.goals = []

  S=$scope;

  $scope.fibonacciClient = new ROSLIB.ActionClient({
    ros : rosConnection,
  ...
  $scope.sendGoal = function(){
    ...
    var goal = new ROSLIB.Goal({
      actionClient : $scope.fibonacciClient,
...
demoApp.controller('TopicListnerCtl', ['$scope','rosConnection',function($scope, rosConnection) {
...
demoApp.controller('TopicPublisherCtl', ['$scope','rosConnection',function($scope, rosConnection) {
...
demoApp.directive('rosTopic', function(){
  return {
    priority: 450,
    compile: function() {
      return {
...
demoApp.directive('rosMessageType', function(){
  return {
    priority: 450,
    compile: function() {
      return {
...
demoApp.directive('rosWs', ['$rootScope',function($rootScope){
  return {
    priority: 450,
    compile: function() {
      return {
